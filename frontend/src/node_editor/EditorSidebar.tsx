...
export const EditorSidebar: React.FC<EditorSidebarProps> = ({ onAddNode }) => {
    ...
    return (
        <div className={`h-full bg-slate-900 border-r border-slate-500 flex flex-col shrink-0 shadow-xl/30 transition-all duration-300 ${collapsed ? 'w-14' : 'w-55'}`}>

            {/* Header  */}
            <div className="flex items-center justify-between p-4 border-b border-slate-500 h-15">
                {!collapsed && (
            ...
            {/* Footer */}
            {!collapsed && (
                <div className="text-slate-600 italic test-sx p-2">
