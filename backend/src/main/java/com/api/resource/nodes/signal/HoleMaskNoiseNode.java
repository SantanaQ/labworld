...
public class HoleMaskNoiseNode extends EditorNode {
    ...
    public void unpackData(Map<String, Object> data) {
        ...
        this.holeThreshold = getFloat(data, "threshold");
    ...
    public void setHoleThreshold(float holeThreshold) {
